...
HD_PWD='C:/Users/wemid/projects/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Proj3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Proj3_top.tcl -notrace
